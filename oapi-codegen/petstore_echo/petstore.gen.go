...
type ServerInterface interface {
	...
	// (POST /pet)
	AddPet(ctx echo.Context, params AddPetParams) error
	// Update an existing pet
	// (PUT /pet)
	UpdatePet(ctx echo.Context, params UpdatePetParams) error
	...
	PostStoreSubscribe(ctx echo.Context) error
	// Create user
	// (POST /user)
...
func (w *ServerInterfaceWrapper) AddPet(ctx echo.Context) error {
	...
	if cookie, err := ctx.Cookie("cookieParam"); err == nil {

		var value int64
		err = runtime.BindStyledParameterWithLocation("simple", true, "cookieParam", runtime.ParamLocationCookie, cookie.Value, &value)
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter cookieParam: %s", err))
		}
		params.CookieParam = value

	} else {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Query argument cookieParam is required, but not found"))
	}

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.AddPet(ctx, params)
	return err
}
...
func (w *ServerInterfaceWrapper) UpdatePet(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.UpdatePet(ctx, params)
	return err
}
...
// PostStoreSubscribe converts echo context to params.
func (w *ServerInterfaceWrapper) PostStoreSubscribe(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.PostStoreSubscribe(ctx)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/store/subscribe", wrapper.PostStoreSubscribe)
